var FormViewProfesor = Marionette.ItemView.extend({
	...
	template : _.template('<form>\
        ...
        <div class="row"><div class="grid-6"><label for="carrera">Dias Loborales:</label></div><div class="grid-2"><input type="text" id="diasLoborales" value="<%- diasLoborales %>"></div></div>\
